...
/* config */
#define CONFIG_XENO_BUILD_ARGS " 'CFLAGS=-march=armv8-a  -fPIC' 'LDFLAGS=-march=armv8-a' '--build=x86_64-unknown-linux-gnu' '--host=aarch64-linux-gnu' '--with-core=cobalt' '--enable-smp' 'CC=aarch64-linux-gnu-gcc' 'LD=aarch64-linux-gnu-ld' '--prefix=/home/rise0chen/rpi_os/xenomai-3.1/out' 'build_alias=x86_64-unknown-linux-gnu' 'host_alias=aarch64-linux-gnu'"
...
/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 9.3.0 (Ubuntu 9.3.0-17ubuntu1~20.04) "
...
/* Host system alias */
#define CONFIG_XENO_HOST_STRING "aarch64-unknown-linux-gnu"
...
/* config */
#define CONFIG_XENO_PREFIX "/home/rise0chen/rpi_os/xenomai-3.1/out"
